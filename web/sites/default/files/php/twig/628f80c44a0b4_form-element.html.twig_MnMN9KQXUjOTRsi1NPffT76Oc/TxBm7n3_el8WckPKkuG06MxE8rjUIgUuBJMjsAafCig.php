...
class __TwigTemplate_e95cf7bf7713ee98fc2be51be4c63157 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
{% else %}
  <fieldset{{ attributes.addClass(classes, 'mb-3') }}>
    {% if label_display in ['before', 'invisible'] %}
      {{ label }}
    {% endif %}
...
{% endif %}
", "themes/contrib/bootstrap_barrio/templates/form/form-element.html.twig", "/var/www/web/themes/contrib/bootstrap_barrio/templates/form/form-element.html.twig");
    }
