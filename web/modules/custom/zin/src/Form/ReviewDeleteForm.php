...
/**
 * Provides a form for deleting a zin entity.
 *
 * @ingroup zin
 */
class ReviewDeleteForm extends ContentEntityConfirmFormBase {
   ...
   * {@inheritdoc}
   *
   * If the delete command is canceled, return to the review list.
   */
  public function getCancelUrl() {
    return new Url('entity.zin_review.collection');
  }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->logger('zin')->notice('@type: deleted %title.',
      [
